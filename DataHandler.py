...
class DataHandler:
    def __init__(self):
        ...
        elif args.data == 'NYC_spatial_hyperedge':
            predir = 'poisoned_data/enhanced_spatial_attack/NYC/'
        elif args.data == 'NYC_temporal_pattern':
            predir = 'poisoned_data/enhanced_temporal_attack/NYC/'
        elif args.data == 'NYC_cross_category':
            predir = 'poisoned_data/enhanced_cross_category_attack/NYC/'
        else:
            predir = None
        self.predir = predir
        if predir is None:
